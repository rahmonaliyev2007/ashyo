...
function HeaderPopUpCategory() {
  ...
  return (
    <>
    <div className={`${showCategory ? 'h-[70vh] max-[680px]:hidden shadow-lg top-[102px] max-[1220px]:top-[200px]  max-[1220px]:h-[50vh] rounded-[6px] w-[100%]' : "h-[0vh] border-[0px] top-[85px]  max-[1220px]:top-[185px] rounded-[0px] w-[50%]"} absolute duration-300 transition-all  z-[1]  overflow-hidden bg-white mx-auto`}>
